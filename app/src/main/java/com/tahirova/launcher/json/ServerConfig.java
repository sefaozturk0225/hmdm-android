...
package com.tahirova.launcher.json;
...
public class ServerConfig {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("showAdminButton")
    private boolean showAdminButton = true;

    @com.fasterxml.jackson.annotation.JsonProperty("showInfoButton")
    private boolean showInfoButton = true;

    @com.fasterxml.jackson.annotation.JsonProperty("showUpdateButton")
